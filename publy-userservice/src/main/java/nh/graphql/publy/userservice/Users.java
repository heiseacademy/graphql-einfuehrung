...
public class Users {
  public static List<User> users() {
    ...
    users.add(new User("U1", "nils", "Nils Hartmann", "kontakt@nilshartmann.net"));
//    users.add(new User("U1", "nils", "Nils Hartmann", "kontakt@nilshartmann.net", baseUrl + "avatars/nils.jpg", "Hamburg", "Software-Developer from Hamburg", "Beer and GraphQL", "How to teach GraphQL"));
    users.add(new User("U2", "larkin", "Brandt Larkin", "brandt.larkin@example.com"));
    users.add(new User("U3", "treutel", "Vita Treutel", "vita.treutel@example.com"));
    users.add(new User("U4", "purdy", "Deven Purdy", "deven.purdy@example.com"));
    users.add(new User("U5", "satterfield", "Spencer Satterfield", "spencer.satterfield@example.com"));
    users.add(new User("U6", "waters", "Garth Waters", "garth.waters@example.com"));
    users.add(new User("U7", "murphy", "Ethelyn Murphy", "ethelyn.murphy@example.com", "ROLE_GUEST"));
