...
public class NodeGraphQLController {
  ...
  public NodeGraphQLController(MemberGraphQLController memberGraphQLController, StoryGraphQLController storyGraphQLController, CommentRepository commentRepository) {
